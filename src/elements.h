...
// 2014_12_04
  ...
  typedef enum colorCycleModes_e{
    CM_INVALID = -1,
    CM_NONE = 0, CM_ABFADE, CM_RGB, CM_RGBSM, CM_CMY, CM_CMYSM, CM_RWB, CM_RWBSM,
    CM_GRAY, CM_GRAYSM, CM_SYMGRAY, CM_SYMGRAYSM, CM_SECONDARY, CM_TERTIARY,
    CM_RAINBOW, CM_RANDOM, CM_TERTOA,
    CM_COUNT // Last.
  } colorCycleModes_e;
  ...
  typedef enum patternElement_e {
    ...
    PE_LP_BGCMPOS, PE_LP_BGALPHA, PE_PAUSE,
    PE_COUNT // LAst
  } patternElement_e;
  ...
  typedef enum command_e {
    ...
    COM_LOADSET0, COM_LOADSET1, COM_LOADSET2, COM_LOADSET3, COM_LOADSET4,
    COM_LOADSET5, COM_LOADSET6, COM_LOADSET7, COM_LOADSET8, COM_LOADSET9,
    COM_COPYSET0, COM_COPYSET1, COM_COPYSET2, COM_COPYSET3, COM_COPYSET4,
    COM_COPYSET5, COM_COPYSET6, COM_COPYSET7, COM_COPYSET8, COM_COPYSET9,
    ...
    COM_EXCHANGE, COM_BLEND_RST, COM_BLEND_INC, COM_BLEND_DEC, COM_BLENDINC_RST,
    COM_BLENDINC_INC, COM_BLENDINC_DEC, COM_BLENDSWITCH, COM_BLENDSWITCH_RST,
    COM_RST_FLOAT, COM_INC_FLOAT, COM_DEC_FLOAT, COM_BOOL_FLIP, COM_ENUM_RST,
    COM_ENUM_INC, COM_ENUM_DEC, COM_INT_RST, COM_INT_INC, COM_INT_DEC,
    COM_LINT_DEC, COM_LINT_INC, COM_BOOL_RST, COM_BROAD_FLIP, COM_BROAD_RST,
    COM_COUNT // Last
  } command_e;
